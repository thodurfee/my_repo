...
/*
 ...
 Code Purpose : 	This is intended load filenames of the .TXT files
						of the Dun and Bradstreet data for the 
						Master Upload Environment, with the goal
						of outputting a .dta file that is stata usable
...
/***************************************************************************/
/* START:: LOAD_FILENAMES                                                  */
/***************************************************************************/




/*------------------------ Load Log and print time ------------------------*/
cd ./logs;
log using "log.load.file.names.smcl", replace;
di "START:: LOADING FILENAMES: ";
di "TIME:: " c(current_date) " " c(current_time);



/*--------------------------load file names here--------------------------*/
...
/* ------------ count files so you can estimate duration of runtime------ */
local filecount = 0;
...
global filenums = `filecount';



di "END:: LOADING FILENAMES : " ; 
di "TIME:: " c(current_date) " " c(current_time);
log close;
cd ../;
ls;
